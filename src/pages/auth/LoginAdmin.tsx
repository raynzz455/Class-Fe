...
const LoginAdmin: React.FC = () => {
    ...
    return (
        <div className="flex items-center justify-center min-h-screen bg-gray-100 p-4">
            <div className="w-full max-w-lg lg:max-w-md md:max-w-sm sm:max-w-xs shadow-[6px_6px_0px_blue] ring-1 ring-blue-400  bg-white p-8 rounded-lg transition-transform duration-300">
                <h2 className="text-2xl font-bold text-gray-800 text-center mb-8">Login Admin</h2>
